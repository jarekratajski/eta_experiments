...
Frege: 12 Queens, 14200 Solutions. real    0m45.816s
Eta: 12 Queens, 14200 Solutions.  real    0m27.602s
Ghc: 12 Queens, 14200 Solutions.  real    0m9.806s
...
I used Frege ony very shortly.

- Frege is more mature
- Interoperation with Java is easier with Frege
- Frege will probably never be close to GHC
...
## Eta is 0.7.02 not production ready - yet.


If You are haskell developer that sometimes have to publish something to jvm 
you may think of eta.


If you are Java developer looking for more purity -  Frege and Scala  are more mature now.
Check eta progress.
